...
MODULE_DESCRIPTION("Registering a device number and implementing soem callback functions- dummy driver 2");
...
#define DRIVER_NAME "dummydriver2"
#define DRIVER_CLASS "DummyDriverClass2"
...
{
	int retval;
	printk("Hello Kernel - DummyDriver2 reporting!\n");
...
static void __exit ModuleExit(void)
{
	...
	class_destroy(my_class);
	unregister_chrdev_region(my_device_nr, 1);
	printk("Goodbye Kernel - DummyDriver2 over!\n");
}
